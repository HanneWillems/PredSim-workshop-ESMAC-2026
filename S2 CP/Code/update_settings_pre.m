...
S.subject.scale_MT_params = {{'hamstrings_r'},'lMo',0.88,... 		% pROM_Poplbi_R %% to edit 
								{'hamstrings_l'},'lMo',0.92,... 	% pROM_Poplbi_L %% to edit 
								{'iliopsoas_r'},'lMo',0.97,...  	% explained in step 4
								{'iliopsoas_l'},'lMo',0.78,... 	% explained in step 4  (%% to edit)
...
S.subject.set_limit_torque_coefficients_selected_dofs =...
        ...
        {'knee_angle_r','knee_angle_l'},[-6.09,33.94,11.03,-11.33],[-0.1745,-0.1745],... %% to edit
