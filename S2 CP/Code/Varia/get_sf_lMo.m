...
if strcmp(muscle_toScale, 'gastroc')
    ...
    ['Enter lMo scaling factor for soleus ',side ' :']};
    dlgtitle = 'lMo Scaling factors for distal muscles';
    dims =  [0 70; 1 70];
...
elseif strcmp(muscle_toScale, 'hamstrings')
    ...
    'NOTE: If these values have not been scaled , leave them at 1.',...
    ['Enter lMo scaling factor for soleus ',side ' :'],...
    ['Enter lMo scaling factor for gastroc ',side ' :']};
    dlgtitle = 'lMo Scaling factors for distal muscles';
    dims =  [0 70; 1 70; 1 70];
...
elseif  strcmp(muscle_toScale, 'iliopsoas')
        ...
        prompt = { ...
            ...
            ['Enter lMo scaling factor for soleus ',side ' :'],...
            ['Enter lMo scaling factor for gastroc ',side ' :'],...
            ['Enter lMo scaling factor for hamstrings ',side ' :'],...
            ['Enter lMo scaling factor for hamstrings ',other_side ' :']};
        dlgtitle = 'lMo Scaling factors other muscles';
